...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.d(TAG, "onCreate() read up to here");
    ...
    private void initializeData() {
        ...
        String[] mealList = getResources().getStringArray(R.array.meal_title);
        ...
        //Create the ArrayList of meal objects with the titles and information about each sport
        for (int i = 0; i < mealList.length; i++) {
            mealData.add(new MealItem(mealImageResources.getResourceId(i, 0), mealList[i], mealCalories[i], mealIngredient[i], mealRecipeLink[i], mealDescription[i]));
            Log.d(TAG, "initialization() mealData:"+mealData.get(i));
        }
